namespace Romplate
{
	partial class AboutBox
	{
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel.Controls.Add(labelAuthor, 1, 3);
			...
			labelAuthor.Location = new Point(167, 90);
			labelAuthor.Margin = new Padding(7, 0, 4, 0);
			labelAuthor.MaximumSize = new Size(0, 20);
			labelAuthor.Name = "labelAuthor";
			labelAuthor.Size = new Size(316, 20);
			labelAuthor.TabIndex = 22;
			labelAuthor.Text = "Company Name";
